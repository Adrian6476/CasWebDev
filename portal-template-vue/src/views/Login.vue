      ...
      <v-col cols="12" sm="8" md="6" lg="4">
        <v-card class="elevation-12 pa-6">
          ...
          <div class="text-center">
            ...
            <v-btn variant="text" color="primary" :to="{ name: 'register' }" class="mt-2">
...
<script setup>
  ...
  const snackbar = ref({
    ...
    message: '',
    color: 'success',
    timeout: 10000 // Extended display time for Firebase authentication delay
  })
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (result.success) {
        // Wait for notification to complete before redirecting
        setTimeout(() => {
